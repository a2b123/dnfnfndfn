...
extension UIColor {
    ...
    static func qpizzaRed() -> UIColor {
        return UIColor.rgb(red: 186, green: 27, blue: 27)
    }
    
    static func qpizzaWhite() -> UIColor {
        return UIColor.rgb(red: 251, green: 254, blue: 255)
    }
    
    static func qpizzaGold() -> UIColor {
        return UIColor.rgb(red: 250, green: 169, blue: 22)
    }
    
    static func qpizzaCharcol() -> UIColor {
        return UIColor.rgb(red: 109, green: 103, blue: 110)
    }
    
    static func qpizzaBlack() -> UIColor {
        return UIColor.rgb(red: 27, green: 27, blue: 30)
    }
